<?php
  ...
  // a specific contract status and/or linked events has been set to another status.
  ...
  // the linked eventss when it finds an active events that is linked to an
  // expired or ended contract.
  // If omitted it uses the default value of 'nonactive'
  // Example:
  // $config["organization_contracts_eventss_newstatus"] = 'nonactive';  
